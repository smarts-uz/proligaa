...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: LeJ4LqKJQKcN/css
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__zsHu)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__hXEf)}
              />
            </React.Fragment>
          ),
          value: args.children
